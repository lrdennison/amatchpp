...
EOF
      ...
      s.files = ["Gemfile", "Gemfile.lock", "Makefile", "README.md", "Rakefile", "VERSION", "amatchpp.gemspec", "ext", "ext/amatchpp", "ext/amatchpp/DynProg.cpp", "ext/amatchpp/DynProg.hpp", "ext/amatchpp/General.cpp", "ext/amatchpp/General.hpp", "ext/amatchpp/General.o", "ext/amatchpp/Levenshtein.cpp", "ext/amatchpp/Levenshtein.hpp", "ext/amatchpp/Levenshtein.o", "ext/amatchpp/Makefile", "ext/amatchpp/Sellers.cpp", "ext/amatchpp/Sellers.hpp", "ext/amatchpp/Sellers.o", "ext/amatchpp/amatch.orig", "ext/amatchpp/amatchpp.cpp", "ext/amatchpp/extconf.rb", "ext/amatchpp/utils.hpp", "lib", "lib/amatchpp", "lib/amatchpp/version.rb", "tests", "tests/me_first.rb", "tests/test_amatchpp.rb", "tests/test_levenshtein.rb", "tests/test_sellers.rb"]
